    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="text-center">
          ...
          <div className="text-slate-300 font-medium">Loading products...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-4">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="text-sm text-slate-300 bg-slate-800/50 backdrop-blur-sm px-4 py-2 rounded-lg border border-slate-700/50">
            Showing <span className="font-semibold text-white">{filteredProducts.length}</span> of <span className="font-semibold text-white">{products.length}</span> servers
          </div>
        </div>
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-16 bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50">
            ...
            <p className="text-slate-300 text-lg font-medium">No servers match your filters</p>
